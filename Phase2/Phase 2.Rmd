...
Observations with probabilities above 0.5 were classified as "Outcome," while those below 0.5 were classified as "No Outcome." When comparing the predicted outcomes with actual outcomes in the test set, the model’s accuracy was around 64.98%.
